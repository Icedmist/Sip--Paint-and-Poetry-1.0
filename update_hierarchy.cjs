...
const newPresenters = `// ===== PRESENTERS DATA =====
let presenters = [
...
const startPres = html.indexOf('// ===== PRESENTERS DATA =====');
const endPres = html.indexOf('let livePresenterIdx = 0;');
html = html.substring(0, startPres) + newPresenters + '\n' + html.substring(endPres);
